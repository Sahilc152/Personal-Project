...
class TimelineImplTest {
    ...
    void getTimelineDetailsWithMap() {
        ...
        assertEquals("2010-11", timeline.getTimelineDetailsWithMap().get(0).get("title"));
        assertEquals("3.78 (In the Scale of 4.00)", timeline.getTimelineDetailsWithMap().get(0).get("text"));
